...
echo "  commands/          — Skill definitions (gm, triage, my-tasks, enrich, sync, prep, debrief, weekly)"
...
echo "     > /debrief        # End of day capture"
echo "     > /weekly         # Weekly synthesis and goal recalibration"
echo ""
